...
<html lang="en" class="astro-FLTEP2YP">
	<head>
		...
		<link rel="icon" type="image/svg+xml" href="/astrolus/dist/favicon.svg">
	...
	<link rel="stylesheet" href="/astrolus/dist/assets/index.350e2433.css" />
    ...
    <div class="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative astro-UY3JLCBK">
                ...
                <div class="relative z-20 w-full flex justify-between lg:w-max md:px-0 astro-UY3JLCBK">
                    <a href="#" aria-label="logo" class="flex space-x-2 items-center astro-UY3JLCBK">
                        ...
                        <span class="text-2xl font-bold text-gray-900 dark:text-white astro-UY3JLCBK">Astrolus</span>
                    </a>
...
@php $slug = Str::slug($term); @endphp 
<input type="radio" name="my_tabs_plans" role="tab" class="tab" aria-label="{{ $term }}" />
